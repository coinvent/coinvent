...
def getBlendCombiCost(genInputSpaces):
    ...
    for specName1 in genInputSpaces.keys():
        ...
        for specName2 in genInputSpaces.keys():
            ...
            for genSpace1 in genInputSpaces[specName1]:
                ...
                for genSpace2 in genInputSpaces[specName2]:
                    gs2Ctr = gs2Ctr + 1
                    # if genSpace1.totalSteps != totalStepsNumber and genSpace1.totalSteps != totalStepsNumber:
                    #     continue
                    # if genSpace2.totalSteps > totalStepsNumber:
                    #     break
                    combi = {}
        ...
        # We have to put the break here, because otherwise blends will be specified twice. I.e., the combi S1_5 and S2_3 but also the combi S2_3 and S1_5 will be produced. This is dirty but works for two specifications. 
        break
    # print "combis:"
    # print combis[-30]
    # exit(1)
